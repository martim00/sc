...
//			assertEquals(1, list.size());  // TODO: tratar diretamente a asserção da list
	...
	@Before
	public void setUp() {
		instrumentClass("bin/StateCoverageAsmTest$Dummy.class");
		result = readClass("bin/StateCoverageAsmTest$Dummy.class");
	}
	...
	public void testLocalVarToLocalVarAssignment() {
		...
		assertCode(setter, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.localAssignment(I)V.c\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.localAssignment(I)V.a\"\n" +
	...
	public void testFieldToLocalVarAssignment() {
		...
		assertCode(setter, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.fieldTolocalVarAssignment()V.b\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.a\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ALOAD 0\n" +
			    		   "    GETFIELD StateCoverageAsmTest$Dummy.a : I\n" +
			    		   "    ISTORE 1\n" +
			    		   "    RETURN\n");
	}
	...
	public void testLocalVarToFieldAssignment() {
		...
		assertCode(method, 
			    		   ...
			    		   "    ISTORE 1\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.a\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.localVarToFieldAssignment()V.local\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ALOAD 0\n" +
			    		   "    ILOAD 1\n" +
			    		   "    PUTFIELD StateCoverageAsmTest$Dummy.a : I\n" +
			    		   "    RETURN\n");
	}
	...
	public void testFieldToFieldAssignment() {
		...
		assertCode(method, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.a\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.other\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ALOAD 0\n" +
			    		   "    ALOAD 0\n" +
			    		   "    GETFIELD StateCoverageAsmTest$Dummy.other : I\n" +
			    		   "    PUTFIELD StateCoverageAsmTest$Dummy.a : I\n" +
			    		   "    RETURN\n");
	}
	...
	public void testReturnField() {
		...
		assertCode(method, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.getA()I\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.a\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ALOAD 0\n" +
			    		   "    GETFIELD StateCoverageAsmTest$Dummy.a : I\n" +
	...
	public void testReturnLocal() {
		...
		assertCode(method, 
			    		   "    BIPUSH 9\n" +
			    		   "    ISTORE 1\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.getLocal()I\"\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.getLocal()I.local\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ILOAD 1\n" +
			    		   "    IRETURN\n");
	}
	...
	public void testShouldInstrumentTests_int() {
		...
		assertCode(method, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.testInt()V\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.BeginTestCapture (Ljava/lang/String;)V\n" +
			    		   "    ICONST_0\n" +
			    		   "    ISTORE 1\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.testInt()V.a\"\n" +
	...
	public void testShouldInstrumentTests_String() {
		...
		assertCode(method, 
			    		   "    LDC \"StateCoverageAsmTest$Dummy.testString()V\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.BeginTestCapture (Ljava/lang/String;)V\n" +
			    		   "    LDC \"test\"\n" +
			    		   "    ASTORE 1\n" +
			    		   "    LDC \"StateCoverageAsmTest$Dummy.testString()V.a\"\n" +
			    		   "    INVOKESTATIC statecoverage/StateCoverage.AddAssert (Ljava/lang/String;)V\n" +
			    		   "    LDC \"test\"\n" +
			    		   "    ALOAD 1\n" +
	...
	public void testShouldInstrumentListModifications() {
		...
		assertEquals(9, method.instructions.size());
		assertCode(method, 
						   "    LDC \"StateCoverageAsmTest$Dummy.list\"\n" +
						   "    LDC \"\"\n" + 
						   "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    		   "    ALOAD 0\n" +
						   "    GETFIELD StateCoverageAsmTest$Dummy.list : Ljava/util/List;\n" + 
			    		   "    LDC \"aaa\"\n" +
	...
	public void testInstrumentAssertWithCalls() {
		...
		assertEquals(12, method.instructions.size());
		assertCode(method, 
						   "    LDC \"StateCoverageAsmTest$Dummy.testAssertWithMethodCall()V\"\n" +
						   "    INVOKESTATIC statecoverage/StateCoverage.BeginTestCapture (Ljava/lang/String;)V\n" +
						   "    LDC \"StateCoverageAsmTest$Dummy.getA()I\"\n" +
						   "    INVOKESTATIC statecoverage/StateCoverage.AddAssert (Ljava/lang/String;)V\n" +
						   "    LCONST_1\n" +
						   "    ALOAD 0\n" +
						   "    INVOKEVIRTUAL StateCoverageAsmTest$Dummy.getA ()I\n" +
						   "    I2L\n" +
						   "    INVOKESTATIC org/junit/Assert.assertEquals (JJ)V\n" +
						   "    LDC \"StateCoverageAsmTest$Dummy.testAssertWithMethodCall()V\"\n" +
						   "    INVOKESTATIC statecoverage/StateCoverage.EndTestCapture (Ljava/lang/String;)V\n" +
	...
	public void testShouldAddDependencyOnListProperties() {
		assertInstrumentation(12, "getListCount", 7, 
			    ...
			    "    LDC \"StateCoverageAsmTest$Dummy.getListCount()I\"\n" +
			    "    LDC \"StateCoverageAsmTest$Dummy.list\"\n" +
			    "    INVOKESTATIC statecoverage/StateCoverage.AddDependency (Ljava/lang/String;Ljava/lang/String;)V\n" +
			    "    ALOAD 0\n" +
			    "    GETFIELD StateCoverageAsmTest$Dummy.list : Ljava/util/List;\n" +
	...
	public void testAssertListProperties() {
		assertInstrumentation(11, "testAssertListProperties", 17, 
			    ...
			    "    LDC \"StateCoverageAsmTest$Dummy.testAssertListProperties()V\"\n" +
			    "    INVOKESTATIC statecoverage/StateCoverage.BeginTestCapture (Ljava/lang/String;)V\n" +
			    "    LDC \"StateCoverageAsmTest$Dummy.getListCount()I\"\n" +
			    "    INVOKESTATIC statecoverage/StateCoverage.AddAssert (Ljava/lang/String;)V\n" +
			    "    ALOAD 0\n" +
			    ...
			    "    LCONST_1\n" +
			    "    ALOAD 0\n" +
			    "    INVOKESPECIAL StateCoverageAsmTest$Dummy.getListCount ()I\n" +
			    "    I2L\n" +
			    "    INVOKESTATIC org/junit/Assert.assertEquals (JJ)V\n" +
			    "    LDC \"StateCoverageAsmTest$Dummy.testAssertListProperties()V\"\n" +
			    "    INVOKESTATIC statecoverage/StateCoverage.EndTestCapture (Ljava/lang/String;)V\n" +
